	...
	<div id="page">
		...
		<aside id="colorlib-hero" class="breadcrumbs">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url({{asset('fontend/images/cover-img-1.jpg')}});">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
	...
	<!-- jQuery -->
	<script src="{{ aseet('fontend/js/jquery.min.js')}}"></script>
	<!-- jQuery Easing -->
	<script src="{{ aseet('fontend/js/jquery.easing.1.3.js')}}"></script>
	<!-- Bootstrap -->
	<script src="{{ aseet('fontend/js/bootstrap.min.js')}}"></script>
	<!-- Waypoints -->
	<script src="{{ aseet('fontend/js/jquery.waypoints.min.js')}}"></script>
	<!-- Flexslider -->
	<script src="{{ aseet('fontend/js/jquery.flexslider-min.js')}}"></script>
	<!-- Owl carousel -->
	<script src="{{ aseet('fontend/js/owl.carousel.min.js')}}"></script>
	<!-- Magnific Popup -->
	<script src="{{ aseet('fontend/js/jquery.magnific-popup.min.js')}}"></script>
	<script src="{{ aseet('fontend/js/magnific-popup-options.js')}}"></script>
	<!-- Date Picker -->
	<script src="{{ aseet('fontend/js/bootstrap-datepicker.js')}}"></script>
	<!-- Stellar Parallax -->
	<script src="{{ aseet('fontend/js/jquery.stellar.min.js')}}"></script>
	<!-- Main -->
	<script src="{{ aseet('fontend/js/main.js"></script>
