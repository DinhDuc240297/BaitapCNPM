...
<html>
  <head>
    ...
    <link href="{{ asset("/asset/plugins/daterangepicker/daterangepicker.css")}}" rel="stylesheet" type="text/css" />
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <script  src="{{ asset ("/asset/plugins/fastclick/fastclick.js") }}" type="text/javascript" ></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
    <script  src="{{ asset ("/asset/plugins/input-mask/jquery.inputmask.js") }}" type="text/javascript" ></script>
    <script  src="{{ asset ("/asset/plugins/input-mask/jquery.inputmask.date.extensions.js") }}" type="text/javascript" ></script>
    <script  src="{{ asset ("/asset/plugins/input-mask/jquery.inputmask.extensions.js") }}" type="text/javascript" ></script>
