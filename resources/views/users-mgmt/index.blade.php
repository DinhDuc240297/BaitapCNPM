  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('user-management.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['User Name', 'level'], 
          'oldVals' => [isset($searchingVals) ? $searchingVals['username'] : '', isset($searchingVals) ? $searchingVals['level'] : '']])
          @endcomponent
          </br>
        @endcomponent
      </form>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="20%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="level: activate to sort column ascending">Level</th>
